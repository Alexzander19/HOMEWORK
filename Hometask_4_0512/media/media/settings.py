...
SECRET_KEY = 'django-insecure-hve850hh5$i_3p*edjc(lksde_4)c9p!y6+p7_&sva)yj4$m$m'
...
LOGIN_URL = '/user/signin/'  #  Автоматический редирект на эту страницу, если для отображения страницы нужна авторизация
